.. TIKAL documentation master file, created by
   sphinx-quickstart on Sat Jan 10 19:28:57 2026.
...
Besides reading the documentation you should also take a look at https://github.com/MoonShardFlower/tikal-library/tree/main/examples
for (heavily commented) usage examples. In fact I think the examples will be much more useful than this documentation.
The documentation is auto-generated using Sphinx. This is my first time using it and my knowledge is still lacking.
